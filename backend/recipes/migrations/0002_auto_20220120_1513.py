# Generated by Django 2.2.26 on 2022-01-20 15:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(through='recipes.IngredientInRecipeForRecipe', to='recipes.IngredientInRecipe'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='tags',
            field=models.ManyToManyField(through='recipes.TagForRecipe', to='recipes.Tag'),
        ),
        migrations.AddField(
            model_name='ingredientinrecipeforrecipe',
            name='ingredient',
